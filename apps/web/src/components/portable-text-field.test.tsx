...
// Verifies the official Portable Text editor hydrates canonical saved blocks instead of opening empty.

import { cleanup, render, screen } from "@testing-library/react";
import { afterEach, describe, expect, it, vi } from "vitest";

import PortableTextField from "./portable-text-field";
...
describe("portable text field", () => {
  ...
  it("hydrates a saved canonical document", async () => {
    render(
      <PortableTextField
        label="Body"
        value={{
