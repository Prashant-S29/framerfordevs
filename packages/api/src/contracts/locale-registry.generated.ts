...
export const scriptSubtagAliases: ReadonlyMap<string, string> = new Map([]);
export const regionSubtagAliases: ReadonlyMap<string, string> = new Map([
  ["bu", "MM"],
  ["dd", "DE"],
  ["fx", "FR"],
  ["tp", "TL"],
...
export const variantSubtagAliases: ReadonlyMap<string, string> = new Map([["heploc", "alalc97"]]);
export const extlangTagAliases: ReadonlyMap<string, string> = new Map([
  ["ar-aao", "aao"],
  ["ar-abh", "abh"],
  ["ar-abv", "abv"],
  ["ar-acm", "acm"],
...
export const registeredTagAliases: ReadonlyMap<string, string> = new Map([
  ["art-lojban", "jbo"],
...
export const unsupportedGrandfatheredTags: ReadonlySet<string> = new Set(
  "cel-gaulish|i-default|i-enochian|i-mingo|zh-min".split("|"),
);
