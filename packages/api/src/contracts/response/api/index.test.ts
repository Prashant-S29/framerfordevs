...
describe("application error mapping", () => {
  ...
  const cases = [
    ...
    DeliveryQueryInvalidFailure.make({ details }),
    DeliveryCursorInvalidFailure.make(),
    DeliveryCursorStaleFailure.make(),
    DeliveryResponseTooLargeFailure.make(),
    PreviewQueryInvalidFailure.make({ details }),
    PreviewRevisionIncompatibleFailure.make(),
    PreviewResponseTooLargeFailure.make(),
    PreviewDocumentCorruptFailure.make(),
    ToolingCursorInvalidFailure.make(),
    ToolingConcurrentSchemaChangeFailure.make(),
    ToolingResponseTooLargeFailure.make(),
    ControlPlaneCommandConflictFailure.make(),
    ControlPlaneCursorInvalidFailure.make(),
    ControlPlaneRequestTooLargeFailure.make(),
    ControlPlaneResponseTooLargeFailure.make(),
    ...
    expect(mapped).toMatchInlineSnapshot(`
      [
        ...
        },
        {
          ...
          "retryable": false,
          "status": 400,
          "tag": "DeliveryQueryInvalidFailure",
        },
        {
          "code": "DELIVERY_CURSOR_INVALID",
          "retryable": false,
          "status": 400,
          "tag": "DeliveryCursorInvalidFailure",
        },
        {
          "code": "DELIVERY_CURSOR_STALE",
          "retryable": true,
          "status": 409,
          "tag": "DeliveryCursorStaleFailure",
        },
        {
          "code": "DELIVERY_RESPONSE_TOO_LARGE",
          "retryable": false,
          "status": 413,
          "tag": "DeliveryResponseTooLargeFailure",
        },
        {
          "code": "PREVIEW_QUERY_INVALID",
          "retryable": false,
          "status": 400,
          "tag": "PreviewQueryInvalidFailure",
        },
        {
          "code": "PREVIEW_REVISION_INCOMPATIBLE",
          "retryable": false,
          "status": 409,
          "tag": "PreviewRevisionIncompatibleFailure",
        },
        {
          "code": "PREVIEW_RESPONSE_TOO_LARGE",
          "retryable": false,
          "status": 413,
          "tag": "PreviewResponseTooLargeFailure",
        },
        {
        ...
        },
        {
          ...
          "retryable": false,
          "status": 400,
          "tag": "ToolingCursorInvalidFailure",
        },
        {
          "code": "TOOLING_CONCURRENT_SCHEMA_CHANGE",
          "retryable": true,
          "status": 409,
          "tag": "ToolingConcurrentSchemaChangeFailure",
        },
        {
          "code": "TOOLING_RESPONSE_TOO_LARGE",
          "retryable": false,
          "status": 413,
          "tag": "ToolingResponseTooLargeFailure",
        },
        {
          "code": "COMMAND_CONFLICT",
          "retryable": false,
          "status": 409,
          "tag": "ControlPlaneCommandConflictFailure",
        },
        {
          "code": "CONTROL_PLANE_CURSOR_INVALID",
          "retryable": false,
          "status": 400,
          "tag": "ControlPlaneCursorInvalidFailure",
        },
        {
          "code": "CONTROL_PLANE_REQUEST_TOO_LARGE",
          "retryable": false,
          "status": 413,
          "tag": "ControlPlaneRequestTooLargeFailure",
        },
        {
          "code": "CONTROL_PLANE_RESPONSE_TOO_LARGE",
          "retryable": false,
          "status": 413,
          "tag": "ControlPlaneResponseTooLargeFailure",
        },
        {
    ...
    expect({
    ...
    }).toMatchInlineSnapshot(`
      {
        "failures": [
          ...
          "false:null:CONTROL_PLANE_CURSOR_INVALID:400",
          "false:null:CONTROL_PLANE_REQUEST_TOO_LARGE:413",
          "false:null:CONTROL_PLANE_RESPONSE_TOO_LARGE:413",
          ...
          "false:null:PREVIEW_REVISION_INCOMPATIBLE:409",
          "false:null:PROJECT_KEY_CONFLICT:409",
          "false:null:PUBLICATION_CONFLICT:409",
          "false:null:PUBLICATION_INVALID:422",
          "false:null:PUBLISHED_SCHEMA_REQUIRED:409",
          "false:null:RATE_LIMITED:429",
          "false:null:REQUEST_TOO_LARGE:413",
          "false:null:RESPONSE_TOO_LARGE:413",
          "false:null:RISKY_ACKNOWLEDGEMENT_REQUIRED:409",
          ...
          "false:null:TOOLING_CONCURRENT_SCHEMA_CHANGE:409",
          "false:null:TOOLING_CURSOR_INVALID:400",
          "false:null:TOOLING_RESPONSE_TOO_LARGE:413",
