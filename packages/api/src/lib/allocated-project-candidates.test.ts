...
import { AuthoringSchemaAuthority, ProjectStructureManifestHash } from "../contracts/authoring";
...
import { buildAllocatedProjectCandidates } from "./allocated-project-candidates";
import { buildAuthoringProjectPlan } from "./authoring-project-plan";
