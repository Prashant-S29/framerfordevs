// Defines authenticated dashboard Preview workflows at the Effect application boundary.

import { Clock, Effect, Schema } from "effect";

import type { GetCurrentUserPreviewInput, GetRevisionUserPreviewInput } from "../contracts/preview";
import { RateLimitedFailure, UnauthorizedFailure } from "../contracts/errors";
