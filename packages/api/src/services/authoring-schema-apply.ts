...
import { buildAllocatedProjectCandidates } from "../lib/allocated-project-candidates";
...
import { reconcileProjectSourceIdentities } from "../lib/source-reconciliation";
import {
  computeProjectStructureManifestHash,
  type StructureIdentityMap,
} from "../lib/structure-hash";
...
import { loadAuthoringProjectPlanContext } from "./authoring-schema-repository";
