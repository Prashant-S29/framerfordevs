...
import { compareCanonicalText } from "../lib/field-system-document";
import { flattenFieldTree } from "../lib/field-tree";
import { computeProjectStructureManifestHash } from "../lib/structure-hash";
import {
  applyAuthoringProjectSchema,
  type AuthoringSchemaApplyDecision,
  type AuthoringSchemaApplyFailureStage,
} from "./authoring-schema-apply";
import {
