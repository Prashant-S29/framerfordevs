...
export function validateFlags(arguments_: ParsedArguments): void {
  ...
  > = {
    ...
    "workspace list": { api: "string", limit: "string", cursor: "string", json: "boolean" },
    "workspace get": { api: "string", workspace: "string", json: "boolean" },
    "workspace create": {
      api: "string",
      name: "string",
      "command-id": "string",
    ...
    "project get": { api: "string", project: "string", json: "boolean" },
    "project create": {
      api: "string",
      workspace: "string",
      name: "string",
    ...
    "project capabilities": { api: "string", project: "string", json: "boolean" },
